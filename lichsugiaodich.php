...
<body>
	...
	<div id="content">
		<div class="head" style="text-align: center; padding-left:140px;">
			...
			<div id="cart-icon" style="padding-right: 550px; margin-top: -43px;">
				<a href="./cart.html"><ul>
					<li style="list-style-type: none; font-size: 15px; padding-left: 280px; width: 100px;">
							<i class="fas fa-shopping-cart" style="font-size: 15px; color: white; width: 100px;"> Giỏ hàng</i>
					</li>
				</ul>
			</a>
			</div>
		...
		<div class="nav">
		  ...
		  <div class="dropdown" style="float: left; margin-top:-57px;margin-left: 1180px; display: none" id="admin">
			...
			<div class="dropdown" style="float: left; margin-top:-57px;margin-left: 1180px; display: none" id="userbanhang">
			 <a href="Nhanvien-hoadon.php"><button class="dropbtn" style="width: 100px; height: 50px;">Nhânviên</button></a> 
		</div>
		</div>
		<div>
			<table>
				  <tr>
					...
					<th>Sản phẩm giao dịch</th>
					<th>Số tiền</th>
					<th>Tình trạng</th>
				  </tr>
					<?php					 	
					 	$p->selectlichsugiaodich("select * from hoadon");
					 ?>				  
			</table>
		</div>
		</div>	
